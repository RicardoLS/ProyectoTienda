	...
	if(isset($_SESSION['carrito'])){
		if(isset($_GET['id'])){
					...
					if($encontro==true){
						...
						$precio=0;
						$imagen="";
						$re=mysqli_query($dbc,"select * from productos where id=".$_GET['id']);
...
<body background="productos/fon.jpg">
	...
	?>
		...
		<?php
			...
			if($total!=0){
					echo '<center><a href="./compras/compras.php" class="aceptar" id = "dise">Realizar Factura</a></center>';
			}
			
		?>
		<br><br>
		<center><a href="./stante.php">Ver catalogo</a></center>
